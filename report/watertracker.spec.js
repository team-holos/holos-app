...
test.describe("Registration and Login Tests", () => {
  ...
  test("water consumption test", async ({ page }) => {
    await page.goto("http://localhost:5173/dashboard");
    await page.waitForLoadState("domcontentloaded");
    await page.getByText("Wasser Tracker").toBeVisible();
    await page.getByText("0 ml").toBeVisible();
    await page.getByText("2000 ml").toBeVisible();
    await page.getByText("Wasser getrunken (+250ml)").click();
    await page.getByText("250 ml").toBeVisible();
    await page.getByText("2000 ml").toBeVisible();
  }); 
